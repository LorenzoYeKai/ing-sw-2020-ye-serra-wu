...
public class AthenaPower {
    ...
    @Test
    @DisplayName("Check Athena Power" )
    void athenaPowerTest() throws NotExecutedException {
        controller.getGame().getCurrentPlayer().setGod(GodType.ATHENA);
        ...
        assertTrue(controller.getGame().getCurrentPlayer().getAllWorkers().get(0).getCurrentSpace().equals(controller.getGame().getWorld().getSpaces(2,2)));
