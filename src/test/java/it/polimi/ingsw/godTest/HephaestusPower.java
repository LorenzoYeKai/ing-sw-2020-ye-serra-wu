...
public class HephaestusPower {
    ...
    @Test
    @DisplayName("Check Hephaestus Power" )
    void hephaestusPowerTest() throws NotExecutedException {
        controller.getGame().getCurrentPlayer().setGod(GodType.HEPHAESTUS);
