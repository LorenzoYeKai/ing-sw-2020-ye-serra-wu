...
public class AtlasPower {
    ...
    @Test
    @DisplayName("Check Atlas Power" )
    void atlasPowerTest() throws NotExecutedException {
        controller.getGame().getCurrentPlayer().setGod(GodType.ATLAS);
        controller.getGame().getCurrentPlayer().getGod().activateGodPower(controller.getGame().getCurrentPlayer().getAllWorkers().get(0));
        assertTrue(controller.getGame().getCurrentPlayer().getAllWorkers().get(0).computeDomeSpaces().contains(controller.getGame().getWorld().getSpaces(0,0)));
        assertTrue(controller.getGame().getCurrentPlayer().getAllWorkers().get(0).computeDomeSpaces().contains(controller.getGame().getWorld().getSpaces(1,0)));
        assertTrue(controller.getGame().getCurrentPlayer().getAllWorkers().get(0).computeDomeSpaces().contains(controller.getGame().getWorld().getSpaces(2,1)));
