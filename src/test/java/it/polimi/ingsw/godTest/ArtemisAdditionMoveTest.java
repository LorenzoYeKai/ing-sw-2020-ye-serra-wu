...
public class ArtemisAdditionMoveTest {
    Game game;
    ...
    @Test
    @DisplayName("Check Artemis Power" )
    void artemisAdditionMoveTest() throws NotExecutedException {
        controller.getGame().getCurrentPlayer().setGod(GodType.ARTEMIS);
        controller.move(controller.getGame().getCurrentPlayer().getAllWorkers().get(0),controller.getGame().getWorld().getSpaces(1,0));
        assertTrue(controller.getGame().getCurrentPlayer().getAllWorkers().get(0).getCurrentSpace().equals(controller.getGame().getWorld().getSpaces(1,0)));
        ...
        controller.move(controller.getGame().getCurrentPlayer().getAllWorkers().get(0),controller.getGame().getWorld().getSpaces(0,0));
        assertTrue(controller.getGame().getCurrentPlayer().getAllWorkers().get(0).getCurrentSpace().equals(controller.getGame().getWorld().getSpaces(0,0)));
