...
public class ArtemisPowerTest {
    ...
    void artemisPowerTest() throws NotExecutedException {
        controller.getGame().getWorld().clearPreviousWorlds();
        List<WorkerActionType> action = game.getCurrentPlayer().getGod().workerActionOrder(controller.getGame().getTurnPhase(),controller.getGame().getCurrentPlayer().getAvailableWorkers().get(0));
